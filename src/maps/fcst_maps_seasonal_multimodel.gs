...
*************VARIÁVEL**************
namevar=subwrd(args,4)
say namevar
***********************************

*************CALIBRAÇÃO**************
calibration=subwrd(args,5)
say calibration
***********************************
...
**valc='33 32 31 30 29 27 26 25 24 20 20'
        ...
        if (calibration = 'nocalib')
            if (base = 'copernicus')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/copernicus/'version'/forecast/nocalib/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/copernicus/'version'/forecast/nocalib/'model'/'ano'/'anomesdiahora
                '!mkdir -p 'out''                    
            endif
            if (base = 'nmme')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/nmme/'version'/forecast/nocalib/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/nmme/'version'/forecast/nocalib/'model'/'ano'/'anomesdiahora'/'
                '!mkdir -p 'out''   
            endif
            file = 'fcst_'namevar'_'met'_'plt''lt'_'model'_calibrated_nocalib_'anomesdiahora'.nc'
        endif

        if (calibration = 'regr')
            if (base = 'copernicus')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/copernicus/'version'/forecast/regr/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/copernicus/'version'/forecast/regr/'model'/'ano'/'anomesdiahora'/'
                '!mkdir -p 'out''   
            endif
            if (base = 'nmme')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/nmme/'version'/forecast/regr/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/nmme/'version'/forecast/regr/'model'/'ano'/'anomesdiahora'/'
                '!mkdir -p 'out''   
            endif
        ...
        if (calibration = 'cox')
            if (base = 'copernicus')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/copernicus/'version'/forecast/cox/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/copernicus/'version'/forecast/cox/'model'/'ano'/'anomesdiahora'/'
                '!mkdir -p 'out''   
            endif
            if (base = 'nmme')
                path_in = '/dados/mmclima/multimodelo/seasonal/posproc/nmme/'version'/forecast/cox/'model'/'ano'/'anomesdiahora'/'
                out     = '/dados/mmclima/multimodelo/seasonal/figures/nmme/'version'/forecast/cox/'model'/'ano'/'anomesdiahora'/'
                '!mkdir -p 'out''   
            endif
        ...
        if (base = 'nmme')
            ...
            if (calibration = 'regr')
            l1='NMME + CPTEC MULTIMODEL CALIBRATED (REGR.)'
            endif
            if (calibration = 'cox')
