...
## Mapas de verificacao

```bash
streamlit run streamlit/verification_app.py
```

O app mostra apenas figuras em caminhos `.../verification/...`. A pasta pode ser a raiz geral:
...
```text
/dados/mmclima/multimodelo/seasonal/figures/nmme/v1/verification
```
